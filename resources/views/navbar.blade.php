    ...
    <div class="collapse navbar-collapse tabs">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item wow">
          <a class="nav-link fas fa-shopping-cart" href="#">cart({{$total}})</a>
        </li>

        @if(Session::has('LoggedUser'))
        <li class="dropdown">
      <a class="dropdown-toggle lead" data-toggle="dropdown" href="#" style="color: white; text-decoration: none;">{{}} </a>
